...
<?php endif; ?>
    ...
    <div class="row p-5 ps-2 fw-bolder">
        ...
        <div class="col-3 pt-3"><?php echo $item['date']; ?></div>
        <div class="col-3 pt-3 ps-5"><?php echo $item['feedback']; ?></div>
        <div class="col-3 pt-3">
            
            <a class=" ps-4" href="deleteFeedback.php?userId=<?php echo $item['id']; ?>"><button class="btn btn-danger ">DELETE</button></a>
        </div>
    </div>
<?php endforeach; ?>
