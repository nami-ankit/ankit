...
<?php endif; ?>
    ...
    <section class="container mt-5">
      ...
      <form method="POST" action="addProduct.php"  class="form" enctype="multipart/form-data">
        <div class="input-box">
          <label>Name</label>
          <input type="text" name="name" placeholder="Enter the product full name" required />
        </div>
        ...
        <div class="input-box">
          ...
          <input type="text" name="description" placeholder="Give us your description" required />
        </div>
